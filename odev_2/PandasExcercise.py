...
tips_df.loc[(tips_df["time"] == "Lunch") & (tips_df["sex"] == "Female"), ["total_bill", "tip", "day"]].groupby("day").agg({"tip": ["sum", "min", "max", "mean"]})
...
total_bill_tip_sum = tips_df["total_bill"] + tips_df["tip"]

# Görev 23: total_bill_tip_sum değişkenine göre büyükten küçüğe sıralayınız ve ilk 30 kişiyi yeni bir dataframe'e atayınız.
new_dataframe = pd.DataFrame(total_bill_tip_sum.sort_values(ascending=False).head(30))
